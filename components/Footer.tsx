    ...
    return (
        <footer className="flex justify-between items-center p-6 bg-white shadow text-gray-800 drop-shadow-sm">
            ...
            <div className="flex gap-4 text-md">
                <Link href={`/${currentLocale}/privacy`} className="hover:underline">Privacy Policy</Link>
                <Link href={`/${currentLocale}/terms`} className="hover:underline">Terms of Service</Link>
            </div>
        </footer>
    );
}